...
/* ********************************************* ONLY TEAM ********************************************* */
    ...
    **/
    function addDividend(uint256 _dripTimeInSeconds)
      external
      payable
    {            
    ...
    **/
    function transferRewarder(address _newRewarder)
      external
    {
    ...
    **/
    function blacklistAddress(address _user, bool _blacklisted)
      external
      onlyOwnerOrTreasury
    {
