...
interface IRouter {
    ...
    function swapExactTokensForEth(uint256 amountIn, uint256 minAmountOut, address[] memory path, address to, uint256 deadline) external returns (uint256);
}
...
/* ********************************************* INTERNAL ********************************************* */
    ...
    **/
    function determineTax(address _from, address _to, uint256 _value)
      internal
      view
...
/* ********************************************* ONLY OWNER/TREASURY ********************************************* */
    ...
    **/
    function transferTreasury(address _newTreasury)
      external
      onlyOwnerOrTreasury
    {
    ...
    **/
    function changeMinSell(uint256 _newMinSell)
      onlyOwnerOrTreasury
      external
    {
        minSell = _newMinSell;
    ...
    **/
    function changeDex(address _dexAddress)
      external
      onlyOwnerOrTreasury
    {
        dex = _dexAddress;
...
/* ********************************************* ONLY OWNER ********************************************* */
    ...
    **/
    function setTaxes(address _dex, uint256 _buyTax, uint256 _sellTax)
      external 
      onlyOwner
    {
